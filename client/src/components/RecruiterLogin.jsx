...
const RecruiterLogin = () => {
    ...
    {state !=="Login" && <div className='border px-4 py-2 flex items-center gap-2 rounded-full mt-5 '>
        ...
        {state === "Login" && <p className='text-left text-sm text-blue-400 cursor-pointer hover:underline mt-2'>
            Forgot Password?
        </p> }

        <button type='submit' className='bg-blue-600 text-white px-6 py-2 rounded-full font-bold hover:bg-blue-500 shadow transition cursor-pointer w-full mt-5'>
